...
object Json4sFormat {
  ...
  def native(numberMode: NumberMode = NumberMode.UseBigDecimal) = new JsonFormat[JValue] {
  ...
  def jackson(numberMode: NumberMode = NumberMode.UseBigDecimal) = new JsonFormat[JValue] {
