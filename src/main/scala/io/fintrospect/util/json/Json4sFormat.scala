...
abstract class AbstractJson4sFormat(numberMode: NumberMode) extends JsonFormat[JValue, JValue, JField] {
...
object Json4sFormat {
  ...
  def native(numberMode: NumberMode = NumberMode.UseBigDecimal) = new AbstractJson4sFormat(numberMode) {
    import org.json4s._
  ...
  def jackson(numberMode: NumberMode = NumberMode.UseBigDecimal) = new AbstractJson4sFormat(numberMode) {
    import org.json4s._
