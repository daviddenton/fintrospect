...
object ParameterSpec {
  ...
  def json[T](name: String, description: String = null, format: JsonFormat[T, _, _] = Argo.JsonFormat) = ParameterSpec[T](name, Option(description), ObjectParamType, format.parse, format.compact)
