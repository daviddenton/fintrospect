...
abstract class Parameters[P[_], Req[_] <: Require[_]] {
  ...
  protected def builder[T](name: String, description: Option[String], paramType: ParamType, parse: (String => Try[T])): P[T] with Req[T]
   ...
   */
  def custom[T](name: String, attemptToParse: String => Try[T], description: String = null): P[T] with Req[T] = builder(name, Option(description), StringParamType, attemptToParse)
   ...
   */
  def localDate(name: String, description: String = null): P[LocalDate] with Req[LocalDate] = builder(name, Option(description), StringParamType, str => Try(LocalDate.parse(str)))
   ...
   */
  def zonedDateTime(name: String, description: String = null): P[ZonedDateTime] with Req[ZonedDateTime] = builder(name, Option(description), StringParamType, str => Try(ZonedDateTime.parse(str)))
   ...
   */
  def dateTime(name: String, description: String = null): P[LocalDateTime] with Req[LocalDateTime] = builder(name, Option(description), StringParamType, str => Try(LocalDateTime.parse(str)))
   ...
   */
  def boolean(name: String, description: String = null): P[Boolean] with Req[Boolean] = builder(name, Option(description), BooleanParamType, str => Try(str.toBoolean))
   ...
   */
  def string(name: String, description: String = null): P[String] with Req[String] = builder(name, Option(description), StringParamType, Try(_))
   ...
   */
  def bigDecimal(name: String, description: String = null): P[BigDecimal] with Req[BigDecimal] = builder(name, Option(description), NumberParamType, str => Try(BigDecimal(str)))
   ...
   */
  def long(name: String, description: String = null): P[Long] with Req[Long] = builder(name, Option(description), IntegerParamType, str => Try(str.toLong))
   ...
   */
  def int(name: String, description: String = null): P[Int] with Req[Int] = builder(name, Option(description), IntegerParamType, str => Try(str.toInt))
   ...
   */
  def integer(name: String, description: String = null): P[Integer] with Req[Integer] = builder(name, Option(description), IntegerParamType, str => Try(new Integer(str)))
   ...
   */
  def json(name: String, description: String = null): P[JsonRootNode] with Req[JsonRootNode] = builder(name, Option(description), ObjectParamType, str => Try(ArgoUtil.parse(str)))
}
