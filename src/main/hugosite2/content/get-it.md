...
libraryDependencies += "io.fintrospect" %% "fintrospect-core" % "14.15.0"
```
...
<tr>
    ...
    <td>application/json</td>
    <td>"io.fintrospect" %% "fintrospect-argonaut" % "14.15.0"</td>
...
<tr>
    ...
    <td>application/json</td>
    <td>"io.fintrospect" %% "fintrospect-circe" % "14.15.0"</td>
...
<tr>
    ...
    <td>application/json</td>
    <td>"io.fintrospect" %% "fintrospect-gson" % "14.15.0"</td>
...
<tr>
    ...
    <td>application/json</td>
    <td>"io.fintrospect" %% "fintrospect-jackson" % "14.15.0"</td>
    <td>
...
<tr>
    ...
    <td>application/json</td>
    <td>"io.fintrospect" %% "fintrospect-json4s" % "14.15.0"</td>
...
<tr>
    ...
    <td>"io.fintrospect" %% "fintrospect-msgpack" % "14.15.0"</td>
...
<tr>
    ...
    <td>application/json</td>
    <td>"io.fintrospect" %% "fintrospect-play" % "14.15.0"</td>
...
<tr>
    ...
    <td>application/json</td>
    <td>"io.fintrospect" %% "fintrospect-spray" % "14.15.0"</td>
...
### message formats
For consuming request parameters in a type-safe way or using the relevan HTTP response builders, add the following:
...
<tr>
  ...
  <td>.hbs</td>
  <td>"io.fintrospect" %% "fintrospect-handlebars" % "14.15.0"</td>
...
<tr>
  ...
  <td>.mustache</td>
  <td>"io.fintrospect" %% "fintrospect-mustache" % "14.15.0"</td>
