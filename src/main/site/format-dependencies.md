...
<tr>
    ...
    <td>application/json</td>
    <td>"io.fintrospect" %% "fintrospect-argonaut" % "13.18.0"</td>
...
<tr>
    ...
    <td>application/json</td>
    <td>"io.fintrospect" %% "fintrospect-circe" % "13.18.0"</td>
...
<tr>
    ...
    <td>application/json</td>
    <td>"io.fintrospect" %% "fintrospect-gson" % "13.18.0"</td>
...
<tr>
    ...
    <td>application/json</td>
    <td>"io.fintrospect" %% "fintrospect-jackson" % "13.18.0"</td>
    <td>
...
<tr>
    ...
    <td>application/json</td>
    <td>"io.fintrospect" %% "fintrospect-json4s" % "13.18.0"</td>
...
<tr>
    ...
    <td>"io.fintrospect" %% "fintrospect-msgpack" % "13.18.0"</td>
...
<tr>
    ...
    <td>application/json</td>
    <td>"io.fintrospect" %% "fintrospect-play" % "13.18.0"</td>
...
<tr>
    ...
    <td>application/json</td>
    <td>"io.fintrospect" %% "fintrospect-spray" % "13.18.0"</td>
