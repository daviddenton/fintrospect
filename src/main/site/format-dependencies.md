...
<tr>
    ...
    <td>application/json</td>
    <td>"io.fintrospect" %% "fintrospect-argonaut" % "14.12.1"</td>
...
<tr>
    ...
    <td>application/json</td>
    <td>"io.fintrospect" %% "fintrospect-circe" % "14.12.1"</td>
...
<tr>
    ...
    <td>application/json</td>
    <td>"io.fintrospect" %% "fintrospect-gson" % "14.12.1"</td>
...
<tr>
    ...
    <td>application/json</td>
    <td>"io.fintrospect" %% "fintrospect-jackson" % "14.12.1"</td>
    <td>
...
<tr>
    ...
    <td>application/json</td>
    <td>"io.fintrospect" %% "fintrospect-json4s" % "14.12.1"</td>
...
<tr>
    ...
    <td>"io.fintrospect" %% "fintrospect-msgpack" % "14.12.1"</td>
...
<tr>
    ...
    <td>application/json</td>
    <td>"io.fintrospect" %% "fintrospect-play" % "14.12.1"</td>
...
<tr>
    ...
    <td>application/json</td>
    <td>"io.fintrospect" %% "fintrospect-spray" % "14.12.1"</td>
