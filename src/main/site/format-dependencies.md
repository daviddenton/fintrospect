...
<tr>
    ...
    <td>application/json</td>
    <td>"io.fintrospect" %% "fintrospect-argonaut" % "13.10.0"</td>
...
<tr>
    ...
    <td>application/json</td>
    <td>"io.fintrospect" %% "fintrospect-circe" % "13.10.0"</td>
...
<tr>
    ...
    <td>application/json</td>
    <td>"io.fintrospect" %% "fintrospect-gson" % "13.10.0"</td>
...
<tr>
    ...
    <td>application/json</td>
    <td>"io.fintrospect" %% "fintrospect-json4s" % "13.10.0"</td>
...
<tr>
    ...
    <td>"io.fintrospect" %% "fintrospect-msgpack" % "13.10.0"</td>
...
<tr>
    ...
    <td>application/json</td>
    <td>"io.fintrospect" %% "fintrospect-play" % "13.10.0"</td>
...
<tr>
    ...
    <td>application/json</td>
    <td>"io.fintrospect" %% "fintrospect-spray" % "13.10.0"</td>
