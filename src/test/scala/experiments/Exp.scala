...
case class PathBuilder0[In, Out](method: Method, terms: Terms, extract: Request => In, bind: Out => Seq[Binding]) extends PathBuilder[In, Request => In] {
  ...
  def bindTo(fn: In => Future[Response]) = new NuServerRoute(method, identity) {
...
case class PathBuilder1[In, PP1](method: Method, terms: Terms, extract: Request => In,
  ...
  def bindTo(fn: (PP1, In) => Future[Response]) = new NuServerRoute(method, identity, pp1) {
    override def toPf(inPath: Path) = {
...
case class PathBuilder2[In, PP1, PP2](method: Method, terms: Terms,
  ...
  def bindTo(fn: (PP1, PP2, In) => Future[Response]) = new NuServerRoute(method, identity, pp1, pp2) {
    override def toPf(inPath: Path) = {
...
case class PathBuilder3[In, PP1, PP2, PP3](method: Method, terms: Terms,
  ...
  def bindTo(fn: (PP1, PP2, PP3, In) => Future[Response]) = new NuServerRoute(method, identity, pp1, pp2, pp3) {
    override def toPf(inPath: Path) = {
...
case class PathBuilder4[In, PP1, PP2, PP3, PP4](method: Method, terms: Terms,
  ...
  def bindTo(fn: (PP1, PP2, PP3, PP4, In) => Future[Response]) = new NuServerRoute(method, identity, pp1, pp2, pp3, pp4) {
    override def toPf(inPath: Path) = {
...
case class PathBuilder5[In, PP1, PP2, PP3, PP4, PP5](method: Method, terms: Terms,
  ...
  def bindTo(fn: (PP1, PP2, PP3, PP4, PP5, In) => Future[Response]) = new NuServerRoute(method, identity, pp1, pp2, pp3, pp4, pp5) {
    override def toPf(inPath: Path) = {
...
case class PathBuilder6[In, PP1, PP2, PP3, PP4, PP5, PP6](method: Method, terms: Terms,
  ...
  def bindTo(fn: (PP1, PP2, PP3, PP4, PP5, PP6, In) => Future[Response]) = new NuServerRoute(method, identity, pp1, pp2, pp3, pp4, pp5, pp6) {
    override def toPf(inPath: Path) = {
