...
- <a target="_top" href="https://github.com/daviddenton/fintrospect/tree/master/src/test/scala/examples/multicontenttypes">```/oauth```</a>- shows how to serve multiple content types from a single route
