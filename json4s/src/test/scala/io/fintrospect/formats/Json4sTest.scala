...
abstract class Json4sAutoSpec[D](json4sLibrary: Json4sLibrary[D]) extends AutoSpec(json4sLibrary.Auto) {
  ...
  override def transform() = json4sLibrary.Auto.tToJValue[Letter]
}

class Json4SNativeAutoTest extends Json4sAutoSpec(Json4s)

class Json4SJacksonAutoTest extends Json4sAutoSpec(Json4sJackson)

class Json4SNativeDoubleModeAutoTest extends Json4sAutoSpec(Json4sDoubleMode)

class Json4SJacksonDoubleModeAutoTest extends Json4sAutoSpec(Json4sJacksonDoubleMode)
